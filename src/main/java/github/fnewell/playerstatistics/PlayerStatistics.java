...
// TODO: Add functionality to single player worlds - not priority
public class PlayerStatistics implements ModInitializer {
	...
	public void onInitialize() {
		...
		// TODO: Download only the required drivers
		// TODO: Add support for MariaDB/Mysql and PostgreSQL (not local SQLite too)
		...
		ServerLifecycleEvents.SERVER_STOPPED.register(server -> StatSyncScheduler.stopScheduledSync());
